        ...
        <div className="border rounded-lg relative px-10 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 sm:mx-auto sm:max-w-2xl sm:rounded-lg sm:px-10">
          <div className="mb-8">
            ...
            <p className="mt-4 text-justify leading-normal">
              ...
              problem-solving ideas directly on an interactive whiteboard. Log
              in to save your notes and revisit them anytime.
            </p>
          </div>
          <div className="flex justify-center items-center space-x-5">
            <p>Visit the problems page := </p>
            <Button
              onClick={() => {
          ...
          <br />
          <div className="flex justify-center items-center space-x-5">
            <p>Want to try a demo before getting started ??</p>
            <Button
              onClick={() => {
                router.push("/demo")
              }}
